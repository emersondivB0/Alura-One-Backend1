...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Long reservaId) throws SQLException {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel(new String[] { "Afganistán", "Alemania", "Árabe", "Argentina",
				"Australia", "Bélgica", "Bolivia", "Brasil", "Camboya", "Canadá", "Chile", "China", "Colombia", "Corea",
				"Costa Rica", "Cuba", "Dinamarca", "Ecuador", "Egipto", "El Salvador", "Escocia", "España",
				"Estados Unidos", "Estonia", "Etiopía", "Filipinas", "Finlandia", "Francia", "Galicia", "Grecia",
				"Guatemala", "Haití", "Holanda", "Honduras", "Indonesia", "Inglaterra", "Irán", "Iraq", "Irlanda",
				"Israel", "Italia", "Japón", "Jordania", "Laos", "Letonia", "Líbano", "Malasia", "Marruecos", "México",
				"Nicaragua", "Noruega", "Nueva Zelanda", "Panamá", "Paraguay", "Perú", "Polonia", "Portugal",
				"Puerto Rico", "República Dominicana", "Rumanía", "Rusia", "Suecia", "Suiza", "Tailandia", "Taiwán",
	...
	private void guardarHuesped() {
	    ...
	    LocalDate fechaN = convertToLocalDateViaInstant((Date) txtFechaN.getDate());
	    String telefono = txtTelefono.getText();

	    // Verificar si se han ingresado todos los campos
	    if (nombre.isEmpty() || apellido.isEmpty() || fechaN == null || telefono.isEmpty()) {
	        JOptionPane.showMessageDialog(null, "Debes llenar todos los campos.");
	        return;
	    }

	    // Guardar los datos del huésped en la tabla huespedes
	    Inquilino nuevoInquilino = new Inquilino(txtNombre.getText(), txtApellido.getText(), fechaN.toString(), (String)txtNacionalidad.getSelectedItem(), txtTelefono.getText(), Long.valueOf(txtNreserva.getText()));
	    this.inquilinoController.guardar(nuevoInquilino);
